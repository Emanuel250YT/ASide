...
export class SocialClient {
  ...
  async getFollowing(options: PaginationOptions & { uuid?: string } = {}): Promise<SocialFollow[]> {
    ...
    const result = await this.cdn.entity
      .query()
      .where([eq(ATTR_TYPE, SOCIAL_FOLLOW_TYPE), eq(ATTR_UUID, uuid)])
      .withPayload(true)
      .fetch()
  ...
  async getFollowers(options: PaginationOptions & { uuid?: string } = {}): Promise<SocialFollow[]> {
    ...
    const result = await this.cdn.entity
      .query()
      .where([eq(ATTR_TYPE, SOCIAL_FOLLOW_TYPE), eq(ATTR_TARGET_UUID, uuid)])
      .withPayload(true)
      .fetch()
  ...
  private async _respondToRequest(
    ...
    const result = await this.cdn.entity
      .query()
      .where([eq(ATTR_TYPE, SOCIAL_FRIEND_REQUEST_TYPE), eq(ATTR_TARGET_UUID, this.uuid)])
      .withPayload(true)
      .fetch()
  ...
  async cancelFriendRequest(entityKey: string): Promise<FriendRequest> {
    const result = await this.cdn.entity
      .query()
      .where([eq(ATTR_TYPE, SOCIAL_FRIEND_REQUEST_TYPE), eq(ATTR_UUID, this.uuid)])
      .withPayload(true)
      .fetch()
  ...
  async getFriends(options: PaginationOptions = {}): Promise<FriendRequest[]> {
    ...
    const result = await this.cdn.entity
      .query()
      .where([eq(ATTR_TYPE, SOCIAL_FRIEND_REQUEST_TYPE)])
      .withPayload(true)
      .fetch()
  ...
  async getBlockedUsers(options: PaginationOptions = {}): Promise<SocialBlock[]> {
    ...
    const result = await this.cdn.entity
      .query()
      .where([eq(ATTR_TYPE, SOCIAL_BLOCK_TYPE), eq(ATTR_UUID, this.uuid)])
      .withPayload(true)
      .fetch()
